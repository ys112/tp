...
public class CommandTestUtil {
    ...
    public static final String VALID_NAME_CHLOE = "Chloe Lim";
    public static final String VALID_PHONE_AMY = "11111111";
    public static final String VALID_PHONE_BOB = "22222222";
    public static final String VALID_PHONE_CHLOE = "33333333";
    public static final String VALID_EMAIL_AMY = "amy@example.com";
    public static final String VALID_EMAIL_BOB = "bob@example.com";
    public static final String VALID_EMAIL_CHLOE = "chloe@example.com";
    public static final String VALID_ADDRESS_AMY = "Block 312, Amy Street 1";
    public static final String VALID_ADDRESS_BOB = "Block 123, Bobby Street 3";
    public static final String VALID_ADDRESS_CHLOE = "Block 456, Chloe Street 2";
    ...
    public static final String NAME_DESC_CHLOE = " " + PREFIX_NAME + " " + VALID_NAME_CHLOE;
    public static final String PHONE_DESC_AMY = " " + PREFIX_PHONE + " " + VALID_PHONE_AMY;
    public static final String PHONE_DESC_BOB = " " + PREFIX_PHONE + " " + VALID_PHONE_BOB;
    public static final String PHONE_DESC_CHLOE = " " + PREFIX_PHONE + " " + VALID_PHONE_CHLOE;
    public static final String EMAIL_DESC_AMY = " " + PREFIX_EMAIL + " " + VALID_EMAIL_AMY;
    public static final String EMAIL_DESC_BOB = " " + PREFIX_EMAIL + " " + VALID_EMAIL_BOB;
    public static final String EMAIL_DESC_CHLOE = " " + PREFIX_EMAIL + " " + VALID_EMAIL_CHLOE;
    public static final String ADDRESS_DESC_AMY = " " + PREFIX_ADDRESS + " " + VALID_ADDRESS_AMY;
    public static final String ADDRESS_DESC_BOB = " " + PREFIX_ADDRESS + " " + VALID_ADDRESS_BOB;
    public static final String ADDRESS_DESC_CHLOE = " " + PREFIX_ADDRESS + " " + VALID_ADDRESS_CHLOE;
    ...
    public static final EditApplicantCommand.EditApplicantDescriptor DESC_CHLOE;
    ...
    static {
        ...
        DESC_CHLOE = new EditApplicantDescriptorBuilder().withName(VALID_NAME_CHLOE)
                .withPhone(VALID_PHONE_CHLOE).withEmail(VALID_EMAIL_CHLOE).withAddress(VALID_ADDRESS_CHLOE)
                .withRole(VALID_ROLE_CHLOE).withStage(VALID_STAGE_CHLOE).build();
    }
